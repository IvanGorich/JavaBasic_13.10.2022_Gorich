package com.hillel.gorich.home_works.home_work2;
...
public class MyApp2 {
    public static void main(String[] args) {
        ...
        System.out.println(" Родом из Харькова.");
        ...
        System.out.println();
        System.out.println("Его географические координаты: 49°99′86.99″ северной широты, 36°23′44.76″ восточной долготы");
        System.out.println();
